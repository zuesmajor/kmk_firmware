...
# encodercount
# keymap
keyboard.keymap = [ [KC.ESCAPE,KC.N1,KC.N2,KC.N3,KC.N4,KC.N5,KC.N6,KC.N7,KC.N8,KC.N9,KC.N0,KC.BSPC,KC.TAB,KC.Q,KC.W,KC.E,KC.R,KC.T,KC.Y,KC.U,KC.I,KC.O,KC.P,KC.MINUS,KC.LCTRL,KC.A,KC.S,KC.D,KC.F,KC.G,KC.H,KC.J,KC.K,KC.L,KC.SCOLON,KC.QUOTE,KC.LSHIFT,KC.Z,KC.X,KC.C,KC.V,KC.B,KC.LBRACKET,KC.RBRACKET,KC.N,KC.M,KC.COMMA,KC.DOT,KC.SLASH,KC.RSHIFT,KC.LALT,KC.MO(1),KC.LGUI,KC.SPACE,KC.ENTER,KC.MO(2),KC.RGUI,KC.RGUI,KC.RIGHT_CURLY_BRACE,KC.RIGHT_CURLY_BRACE,KC.RIGHT_CURLY_BRACE,KC.RIGHT_CURLY_BRACE], 
[KC.F1,KC.F2,KC.F3,KC.F4,KC.F5,KC.F6,KC.CIRCUMFLEX,KC.BSLASH,KC.F9,KC.F10,KC.F11,KC.F12,KC.TRNS,KC.TRNS,KC.UP,KC.TRNS,KC.TRNS,KC.TRNS,KC.AT,KC.HASH,KC.DOLLAR,KC.PERCENT,KC.EQUAL,KC.TRNS,KC.TRNS,KC.LEFT,KC.DOWN,KC.RIGHT,KC.TRNS,KC.TRNS,KC.GRAVE,KC.LEFT_PAREN,KC.RIGHT_PAREN,KC.TILDE,KC.TRNS,KC.TRNS,KC.TRNS,KC.TRNS,KC.TRNS,KC.TRNS,KC.TRNS,KC.TRNS,KC.TRNS,KC.TRNS,KC.EQUAL,KC.PLUS,KC.LEFT_ANGLE_BRACKET,KC.RIGHT_ANGLE_BRACKET,KC.TRNS,KC.TRNS,KC.TRNS,KC.TRNS,KC.TRNS,KC.TRNS,KC.TRNS,KC.TRNS,KC.DELETE,KC.TRNS,KC.RIGHT_CURLY_BRACE,KC.RIGHT_CURLY_BRACE,KC.RIGHT_CURLY_BRACE,KC.RIGHT_CURLY_BRACE], 
